...
import AppointmentOutcomeRecordSystem.PharamcistsAORView;
...
public class Pharmacist extends User {
    ...
    private String age;
    private PharamcistsAORView outcomeRecordView = new PharamcistsAORView();
    ...
    public Pharmacist(String hospitalID, String name, String password, String role, String gender, String age,
        ...
        this.age = age;
        this.outcomeRecordView = new PharamcistsAORView();
    }
    ...
    public void handleOption(int option) throws IOException {
        switch (option) {
            case 1:
                outcomeRecordView.viewAppointmentOutcomeRecord("pending"); //pharmacistAppointmentOutcomeRecord.viewPendingPrescriptions();
                break;
            case 2:
                //pharmacistAppointmentOutcomeRecord.updatePrescriptionStatus();
                break;
            case 3:
