...
public class ConcretePatient extends Patient implements InformationAccess {
    ...
    public ConcretePatient(String hospitalID, String name, String password, String dob, String gender, String bloodType,
            String email, String doctorAssigned, String pastDiagnosis, String pastTreatment, boolean firstLogin,
            String role) {
        super(hospitalID, name, password, dob, gender, bloodType, email, doctorAssigned, pastDiagnosis, pastTreatment,
                firstLogin, role);
    }
                ...
                case 3:
                    ...
                    while (!validEmail) {
                        ...
                        if (email.contains("@")) {
                            validEmail = true;
                            setEmail(email);
                            CSVUpdater.updater(FilePaths.PATIENT_LIST_PATH, getHospitalID(), "Contact Information",
                                    email);
                            System.out.println("Email updated successfully.");
                        } else {
                            System.out.println(
                                    "Invalid email. Please enter a valid email address. Be sure to include '@'");
                        }
                    }
                    break;
                case 4:
