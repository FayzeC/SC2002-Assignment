        ...
        do{
            ...
            switch(choice) {
                case 1:
                    ...
                    user.setName(name);
                    excelUpdater.updateHospitalList(FilePaths.PATIENT_LIST_PATH, getHospitalID(), "Name", name);
                ...
                case 2:
                    ...
                    while (!validDate) {
                        ...
                        if (isValidDate(day, month, year)) {
                            ...
                            setDob(dob);
                            excelUpdater.updateHospitalList(FilePaths.PATIENT_LIST_PATH, getHospitalID(), "Date of Birth", dob);
                ...
                case 3:
                    ...
                    while(!validEmail) {
                        ...
                        if(email.contains("@")){
                            validEmail = true;
                            setEmail(email);
                            excelUpdater.updateHospitalList(FilePaths.PATIENT_LIST_PATH, getHospitalID(), "Contact Information", email);
                ...
                case 4:
                    ...
                    while(!validBloodType) {
                        ...
                        if(bloodType.matches("A\\+|A-|B\\+|B-|AB\\+|AB-|O\\+|O-")){
                            ...
                            excelUpdater.updateHospitalList(FilePaths.PATIENT_LIST_PATH, getHospitalID(), "Blood Type", bloodType);
